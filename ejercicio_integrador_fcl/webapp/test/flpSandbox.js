		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders Qries FCL",
									"targetURL": "#accfclejerciciointegradorfcl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accfclejerciciointegradorfcl-display": {
								"semanticObject": "accfclejerciciointegradorfcl",
								"action": "display",
								"description": "Northwind con Flexible Column Layout",
								"title": "Orders Qries FCL",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.fcl.ejerciciointegradorfcl",
									"url": sap.ui.require.toUrl("acc/fcl/ejerciciointegradorfcl")
								}
							}
						}
					}
