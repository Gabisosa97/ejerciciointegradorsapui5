		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders_Qries",
									"targetURL": "#accintejerciciointegrador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accintejerciciointegrador-display": {
								"semanticObject": "accintejerciciointegrador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.int.ejerciciointegrador",
									"url": sap.ui.require.toUrl("acc/int/ejerciciointegrador")
								}
							}
						}
					}
